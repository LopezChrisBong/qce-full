                    ...
                    <table class="table-fixed">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>20%</td>
                            <td>30% </td>
                            <td><a href="FacultyReportic" class="bg-green-600 px-1 py-1 text-center text-xs py-2 px-2 rounded-md shadow-md hover:bg-green-400 text-[#fff]  ">View Evaluator</a></td>
                          </tr>
                          <tr>
