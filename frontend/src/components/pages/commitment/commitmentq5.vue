...
<div class="flex justify-center">
  ...
  <div style="margin-top: 7rem;">
    <div class="quest5" >Question 1</div>
    <div class="quest5">Question 2</div>
    <div class="quest5">Question 3</div>
    <div class="quest5">Question 4</div>
    <div class="quest5" style="position: relative; border-right: none; background-color: white; ">Question 5</div>
  </div>
