...
<aside id="cta-button-sidebar" class="fixed bg-[#FFFFFF] top-14 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
